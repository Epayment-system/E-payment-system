...
exports.create = async (req, res) => {
  ...
  try {
    ...
    // Add associations with service providers
  ...
  try {
    ...
    if (!user) {
      ...
      try {
        ...
        // update associations with payment, service provider, bill, and Agents
        if (req.body.paymentId) {
          const paymentInstance = await Payment.findByPk(req.body.paymentId);
          if (paymentInstance) {
